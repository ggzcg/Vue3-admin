  ...
  >
    <el-form :model="RoleParams" :rules="rules" ref="form">
      ...
      <el-form-item label="timezone" prop="timezone">
        <el-slider
          @change="handlerSlider($event)"
          v-model="RoleParams.timezone"
          :min="-12"
          :max="12"
        />
      </el-form-item>
...
const handlerSlider = (e: number) => {
  RoleParams.timezone = e
  RoleParams.timer = e
}
const validatorTime = (rule: any, value: any, callBack: any) => {
  console.log(111111, value)
  if (RoleParams.timer !== 0) {
    callBack()
  } else {
    callBack(new Error('timezone'))
  }
}
//职位校验规则
const rules = {
  roleName: [{ required: true, trigger: 'blur', validator: validatorRoleName }],
  timezone: [{ required: true, trigger: 'change', validator: validatorTime }],
}
